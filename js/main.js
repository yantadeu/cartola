...
(function (cartola) {
    ...
    var times = ['cachaca-s-esporte-clube', 'perebas-forever', 'narnia-de-munique', 'sao-bacon-fc', 'goblins-team', 'boletos-fc', 'petrinhus-fc', 'xutebol-club', 'nunes-10', 'mexericons'];
